...
#setwd("../Godefroidt_2021_ReplicationFiles/") 
...
mydata <- read_excel("data/02-metaanalysis-data.xlsx", sheet = "Data", col_names = TRUE, skip = 3)
myotherdata <- read_excel("data/01-sampling-information.xlsx", sheet = "Final sample (N=241)", col_names = TRUE)
...
shinydata$design[shinydata$design==1] <- "Experiment"
shinydata$design[shinydata$design==2] <- "Other"
shinydata$design[shinydata$design==3] <- "Correlation"
shinydata$design[shinydata$design==4] <- "Other"
...
write.csv(shinydata,'shinyapp/main_data.csv')
write.csv(myotherdata,'shinyapp/reports_data.csv')
